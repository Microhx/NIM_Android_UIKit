package com.netease.nim.uikit.support.matisse;
...
/**
 * Created by zhongwu on 2017/11/6.
 */
...
public class GifSizeFilter extends Filter {
    ...
    public UncapableCause filter(Context context, Item item) {
        ...
        if (size.x < mMinWidth || size.y < mMinHeight || item.size > mMaxSize) {
            return new UncapableCause(UncapableCause.DIALOG, context.getString(R.string.error_gif));
        }
        return null;
    }
